...
function showSongs_XML(ajax) {
	...
	// For each song returned for the given top rank, 
	// display the result as li inside the ol with the format : title - artist [genre] (time)
	
	// 1. find all songs XML elements from the Ajax response object
	// 2. for each element, create li element
	// 3. find text values inside title, artist, genre, and time elements
	// 4. set text value inside created li element according to the given format
	// 5. append the li to the ol with id songs
